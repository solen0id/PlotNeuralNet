...
\node[anchor=north west, align=center, draw=black, fill=white, rounded corners, minimum width=\textwidth, inner sep=5pt]
    ...
    \tikz\draw[fill=\InputColor, opacity=0.4] (0,0) rectangle (0.5,0.5); & \tikz\draw[fill=\ConvStridedColor, opacity=0.4] (0,0) rectangle (0.5,0.5); & \tikz\draw[fill=\FcColor, opacity=0.4] (0,0) rectangle (0.5,0.5); & \tikz\draw[fill=\FlatColor, opacity=0.4] (0,0) rectangle (0.5,0.5); & \tikz\draw[fill=\SoftmaxActivationColor, opacity=0.4] (0,0) rectangle (0.5,0.5); & \tikz\draw[fill=\SigmoidActivationColor, opacity=0.4] (0,0) rectangle (0.5,0.5); \\
    \begin{tabular}{c} Input \end{tabular} & \begin{tabular}{c} Strided \\ Convolution \end{tabular} & \begin{tabular}{c} Fully \\ Connected \end{tabular} & \begin{tabular}{c} Flatten \end{tabular} & \begin{tabular}{c} Softmax  \\  Activation \end{tabular} & \begin{tabular}{c} Sigmoid  \\  Activation \end{tabular} \\
    \end{tabular}
};
