...
\pic[shift={(0,0,0)}] at (deconv3_in-east)
    {Box={
        ...
        \draw [connection]  (deconv2-east)    -- node {\midarrow} (deconv3_in-west);
...
\node[anchor=north west, align=center, draw=black, fill=white, rounded corners, minimum width=\textwidth, inner sep=5pt]
    ...
    \begin{tabular}{c} Input \end{tabular} & \begin{tabular}{c} Strided \\ Convolution \end{tabular} & \begin{tabular}{c} Strided \\ Transposed \\ Convolution \end{tabular} & \begin{tabular}{c} Flatten \end{tabular} & \begin{tabular}{c} Reshape \end{tabular} & \begin{tabular}{c} Leaky ReLU  \\  Activation \end{tabular} & \begin{tabular}{c} Tanh  \\  Activation \end{tabular} \\
    \end{tabular}
};
